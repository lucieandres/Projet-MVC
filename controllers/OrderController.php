...
class OrderController extends Controller {
	...
	public function input( $method = INPUT_POST) {
		...
		if ( count( $_POST) > 0) {
			...
			$this->__model->setBirthdate( filter_input( $method, 'birthdate', FILTER_SANITIZE_EMAIL));
			$this->__model->setAdresse( filter_input( $method, 'adresse', FILTER_SANITIZE_EMAIL));
			$this->__model->setTelephone( filter_input( $method, 'telephone', FILTER_SANITIZE_EMAIL));
			$this->__model->setEmailsecours( filter_input( $method, 'emailsecours', FILTER_SANITIZE_EMAIL));
			// Brand and Model
